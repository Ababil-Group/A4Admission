...
const Japan = () => {
  ...
  return (
    <div className="bg-white my-6">
      <Helmet>
        <title>Study Abroad in Japan | A4 Admission</title>

        <meta
          name="description"
          content="Study in Japan and experience world-class education, cutting-edge technology, rich cultural traditions, and a vibrant student life. Learn about Japan’s top universities, cost of living, student visa requirements, and work opportunities for international students with A4 Admission."
        />

        <meta
          name="keywords"
          content="Study in Japan, Japanese Universities, Student Visa Japan, Work Opportunities in Japan, Cost of Living Japan, A4 Admission"
        />

        <meta
          property="og:title"
          content="Study Abroad in Japan | A4 Admission"
        />
        <meta
          property="og:description"
          content="Explore Japan’s prestigious universities, top research opportunities, and the unique blend of culture and technology. Get information on cost of living, student visa, and work opportunities for international students with A4 Admission."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://a4admission.com/pages/study-abroad-japan"
        />

        <link
          rel="canonical"
          href="https://a4admission.com/pages/study-abroad-japan"
        />
        ...
        <meta
          ...
          content="Join Japan’s leading universities, enjoy a rich cultural experience, and discover global career opportunities for international students with A4 Admission."
        />
      </Helmet>
